...
export default function RealTimeData() {
  ...
  useEffect(() => {
    const dataRef = ref(database, "LaylandScehueleRota");
  ...
  return (
    ...
    <OnSiteHeader />
    <div id='SiteButton'>
        <button className='leyland'  onClick={() => handleSiteButtonClick('OnSiteLayland')}>
          Leyland
        </button>
        <button  onClick={() => handleSiteButtonClick('OnSiteManchester')}>Manchester</button>
