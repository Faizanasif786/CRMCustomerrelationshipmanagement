...
export default function RealTimeData() {
  ...
  useEffect(() => {
    const dataRef = ref(database, "MachesterScehueleRota");
  ...
  return (
    ...
    <OnSiteHeader />
    <div id='SiteButton'>
        <button  onClick={() => handleSiteButtonClick('OnSiteLayland')}>
          Leyland
        </button>
        <button className='leyland' onClick={() => handleSiteButtonClick('OnSiteManchester')}>Manchester</button>
        <button onClick={() => handleSiteButtonClick('OnSiteRochland')}>Rochdale</button>
        <button  onClick={() => handleSiteButtonClick('OnSiteBolton')}>Bolton</button>
      </div>
      <div>
