...
import LaylandInvioceModel from "./LaylanInvioceModel";
...
export default function Invoice() {
  ...
  useEffect(() => {
    const approvalsRef = ref(database, "LaylandApprovals");
  ...
  return (
    <>
      ...
      {generatedInvoices.length > 0 && (
        <LaylandInvioceModel data={generatedInvoices} onClose={() => setGeneratedInvoices([])} />
      )}
    </>
  );
}
