...
import BoltonInvioceModel from "./BoltonInvioceModel";
...
export default function Invoice() {
  ...
  useEffect(() => {
    const approvalsRef = ref(database, "boltonApprovals");
  ...
  return (
    <>
      ...
      {generatedInvoices.length > 0 && (
        <BoltonInvioceModel data={generatedInvoices} onClose={() => setGeneratedInvoices([])} />
      )}
    </>
  );
}
