...
import RochdaleInvioceModel from "./RochdaleInvioceModel";
...
export default function Invoice() {
  ...
  useEffect(() => {
    const approvalsRef = ref(database, "RochdaleApprovals");
  ...
  return (
    <>
      ...
      {generatedInvoices.length > 0 && (
        <RochdaleInvioceModel data={generatedInvoices} onClose={() => setGeneratedInvoices([])} />
      )}
    </>
  );
}
